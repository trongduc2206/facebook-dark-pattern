  ...
  return (
    ...
    <div className="topbarContainer">
      ...
      <div className="topbarLinks">
        <div className="topbarCenterIcon">
          <div  className="topbarHomeIcon">
            <Link to="/">
          <HomeIcon style={{fontSize:'30px',color:"rgb(65, 65, 173)",position:'relative',  opacity:'0.7'}}/>
          </Link>
          </div>
          </div>
          <div className="topbarCenterIcon">
      ...
      <div className="topbarRight">
        ...
        <Link to="/profile/duc" style={{textDecoration:'none'}}>
        <img src="/assets/person/duc.jpg" alt="" className="topbarImg"/>
        </Link>
      </div>
    </div>
    </>
